...
# python-dotenv is optional: Docker passes env vars via env_file in docker-compose
try:
...
SECRET_KEY = 'django-insecure-vqqnfe&-=*1ffc3e=o1$u_9ai=^8p48g3_o5exq$c09^f#2t@0'
